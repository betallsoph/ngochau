...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		$$renderer.push(`<div class="space-y-6 max-w-4xl"><div><h1 class="text-2xl font-black text-black">Cấu Hình Tài Khoản</h1> <p class="text-zinc-650 text-sm mt-1 font-bold">Quản lý thương hiệu dịch vụ và tài khoản nhận thanh toán VietQR động</p></div> `);
		$$renderer.push("<!--[0-->");
