...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		$$renderer.push(`<div class="space-y-6"><div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3"><div><h1 class="text-xl sm:text-2xl font-black text-black">Thông Báo &amp; Lời Nhắn</h1> <p class="text-zinc-650 text-sm mt-1 font-bold">Đăng thông báo ghim cho cư dân và theo dõi các lời nhắn đặc biệt</p></div> <button class="bg-blue-300 text-black border-2 border-black px-4 py-2.5 rounded-[6px] shadow-secondary hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all flex items-center gap-1.5 cursor-pointer font-black text-sm w-full sm:w-auto justify-center">Đăng thông báo `);
		Plus($$renderer, { class: "h-4.5 w-4.5" });
		$$renderer.push(`<!----></button></div> <div class="grid gap-6 lg:grid-cols-2"><div class="bg-white border-2 border-black rounded-lg shadow-secondary flex flex-col h-[70vh] overflow-hidden"><div class="p-4 border-b-2 border-black bg-zinc-50 flex items-center justify-between shrink-0 select-none"><h2 class="font-black text-black text-base flex items-center gap-2">Lời nhắn &amp; Đề nghị từ khách `);
